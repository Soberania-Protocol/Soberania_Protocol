 ...
 */
export const PROTOCOLIZATION_EXECUTION_EVENT_TYPES = Object.freeze({
  executed: 'ProtocolizationExecuted',
} as const);

export type ProtocolizationExecutionEventType =
  (typeof PROTOCOLIZATION_EXECUTION_EVENT_TYPES)[keyof typeof PROTOCOLIZATION_EXECUTION_EVENT_TYPES];
