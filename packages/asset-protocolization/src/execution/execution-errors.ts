 ...
 */
export const PROTOCOLIZATION_EXECUTION_ERROR_CODES = Object.freeze({
...
export type ProtocolizationExecutionErrorCode =
  (typeof PROTOCOLIZATION_EXECUTION_ERROR_CODES)[keyof typeof PROTOCOLIZATION_EXECUTION_ERROR_CODES];
...
export class ProtocolizationExecutionError extends Error implements ProtocolError {
  ...
  constructor(
    ...
    message: string,
    details: ProtocolizationExecutionErrorDetails,
  ) {
    super(message);
