 ...
 */
export const PROTOCOLIZATION_READINESS_ERROR_CODES = Object.freeze({
...
export type ProtocolizationReadinessErrorCode =
  (typeof PROTOCOLIZATION_READINESS_ERROR_CODES)[keyof typeof PROTOCOLIZATION_READINESS_ERROR_CODES];
...
export class ProtocolizationReadinessError extends Error implements ProtocolError {
  readonly code: ProtocolizationReadinessErrorCode;
  readonly details: ProtocolizationReadinessErrorDetails;

  constructor(
    code: ProtocolizationReadinessErrorCode,
    message: string,
    details: ProtocolizationReadinessErrorDetails,
  ) {
    super(message);
