...
exports.PROTOCOLIZATION_READINESS_STATE_PRECEDENCE = exports.ProtocolizationRequirementStatus = exports.ProtocolizationRequirementApplicability = exports.ProtocolizationReadinessState = void 0;
exports.deriveProtocolizationReadinessState = deriveProtocolizationReadinessState;
exports.isProtocolizationReadinessState = isProtocolizationReadinessState;
exports.isProtocolizationRequirementApplicability = isProtocolizationRequirementApplicability;
exports.isProtocolizationRequirementStatus = isProtocolizationRequirementStatus;
 ...
 */
exports.ProtocolizationRequirementStatus = {
 ...
 */
const READINESS_STATE_PRECEDENCE = Object.freeze([
    Object.freeze({
        state: exports.ProtocolizationReadinessState.Ineligible,
        reasonCodes: Object.freeze([readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.lifecycleCancelled]),
    }),
    Object.freeze({
        state: exports.ProtocolizationReadinessState.Rejected,
        reasonCodes: Object.freeze([readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.reviewRejected]),
    }),
    Object.freeze({
        state: exports.ProtocolizationReadinessState.Blocked,
        reasonCodes: Object.freeze([readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.reviewConflicting]),
    }),
    Object.freeze({
        state: exports.ProtocolizationReadinessState.MoreEvidenceRequired,
        reasonCodes: Object.freeze([
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.reviewMoreEvidenceRequired,
        ]),
    }),
    Object.freeze({
        state: exports.ProtocolizationReadinessState.EvidencePending,
        reasonCodes: Object.freeze([
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.materialMissing,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.materialInsufficient,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.materialIncompatible,
            ...
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.constraintUnevaluated,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.conditionUnresolved,
        ]),
    }),
    Object.freeze({
        state: exports.ProtocolizationReadinessState.VerificationPending,
        reasonCodes: Object.freeze([
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.verificationMissing,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.verificationFail,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.verificationStale,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.verificationUnavailable,
        ]),
    }),
    Object.freeze({
        state: exports.ProtocolizationReadinessState.ReviewPending,
        reasonCodes: Object.freeze([
            ...
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.verificationManualReview,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.attestationMissing,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.attestationDecisionMissing,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.attestationUnprovenArtifact,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.attestationTypeIncompatible,
            // Resolved by a further review on the newer basis, so it is review work.
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.attestationCurrencyUnresolved,
            readiness_reason_1.PROTOCOLIZATION_READINESS_BLOCKER_CODES.reviewPending,
        ]),
    }),
]);
/**
 ...
 */
exports.PROTOCOLIZATION_READINESS_STATE_PRECEDENCE = READINESS_STATE_PRECEDENCE;
/**
 ...
 */
function deriveProtocolizationReadinessState(blockers) {
    const present = new Set(blockers.map((blocker) => blocker.reasonCode));
    for (const entry of READINESS_STATE_PRECEDENCE) {
        if (entry.reasonCodes.some((code) => present.has(code)))
            return entry.state;
    }
    return exports.ProtocolizationReadinessState.Ready;
}
function isProtocolizationReadinessState(value) {
    return (typeof value === 'string' && Object.values(exports.ProtocolizationReadinessState).includes(value));
}
function isProtocolizationRequirementApplicability(value) {
    return (typeof value === 'string' &&
        Object.values(exports.ProtocolizationRequirementApplicability).includes(value));
}
function isProtocolizationRequirementStatus(value) {
    return (typeof value === 'string' &&
        Object.values(exports.ProtocolizationRequirementStatus).includes(value));
}
