...
exports.PROTOCOLIZATION_READINESS_WARNING_CODE_LIST = exports.PROTOCOLIZATION_READINESS_BLOCKER_CODE_LIST = exports.PROTOCOLIZATION_READINESS_WARNING_CODES = exports.PROTOCOLIZATION_READINESS_BLOCKER_CODES = void 0;
exports.isProtocolizationReadinessBlockerCode = isProtocolizationReadinessBlockerCode;
exports.isProtocolizationReadinessWarningCode = isProtocolizationReadinessWarningCode;
/**
 ...
 */
exports.PROTOCOLIZATION_READINESS_BLOCKER_CODES = Object.freeze({
 ...
 */
exports.PROTOCOLIZATION_READINESS_WARNING_CODES = Object.freeze({
    /**
...
exports.PROTOCOLIZATION_READINESS_BLOCKER_CODE_LIST = Object.freeze(Object.values(exports.PROTOCOLIZATION_READINESS_BLOCKER_CODES));
/** Every warning code, in a stable order for deterministic reporting. */
exports.PROTOCOLIZATION_READINESS_WARNING_CODE_LIST = Object.freeze(Object.values(exports.PROTOCOLIZATION_READINESS_WARNING_CODES));
function isProtocolizationReadinessBlockerCode(value) {
    return (typeof value === 'string' &&
        exports.PROTOCOLIZATION_READINESS_BLOCKER_CODE_LIST.includes(value));
}
function isProtocolizationReadinessWarningCode(value) {
    return (typeof value === 'string' &&
        exports.PROTOCOLIZATION_READINESS_WARNING_CODE_LIST.includes(value));
}
