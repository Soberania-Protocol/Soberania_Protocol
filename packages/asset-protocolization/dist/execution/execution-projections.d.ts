 ...
 */
export declare function isProtocolizationResultCurrentForCase(result: ProtocolizationResult, protocolizationCase: ProtocolizationCase): boolean;
/**
 ...
 */
export declare function listProtocolizationResultsForRevision(results: readonly ProtocolizationResult[], protocolizationCase: ProtocolizationCase): readonly ProtocolizationResult[];
//# sourceMappingURL=execution-projections.d.ts.map