...
exports.isProtocolizationResultCurrentForCase = isProtocolizationResultCurrentForCase;
exports.listProtocolizationResultsForRevision = listProtocolizationResultsForRevision;
 ...
 */
function isProtocolizationResultCurrentForCase(result, protocolizationCase) {
    return (result.tenantId === protocolizationCase.tenantId &&
        result.caseId === protocolizationCase.caseId &&
        (0, case_identifiers_1.protocolizationProfileRefsEqual)(result.profile, protocolizationCase.profile) &&
 ...
 */
function listProtocolizationResultsForRevision(results, protocolizationCase) {
