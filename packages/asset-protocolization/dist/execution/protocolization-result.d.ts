 ...
 * identifier.
 */
export declare const PROTOCOLIZATION_EXECUTION_RESULT_SCHEMA_VERSION = "aoc-protocolization-execution/1";
/**
 ...
 */
export declare function protocolizationMaterialRecordRef(material: ProtocolizationCaseMaterial): string | undefined;
//# sourceMappingURL=protocolization-result.d.ts.map